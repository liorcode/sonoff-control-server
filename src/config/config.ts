...
export default {
  ...
  API_EXTERNAL_HOST: <string> process.env.API_EXTERNAL_HOST,
  API_PORT: <number> toNumber(process.env.API_PORT),
  API_EXTERNAL_PORT: <number> toNumber(process.env.API_EXTERNAL_PORT),
  WEBSOCKET_HOST: <string> process.env.WEBSOCKET_HOST,
  WEBSOCKET_EXTERNAL_HOST: <string> process.env.WEBSOCKET_EXTERNAL_HOST,
  WEBSOCKET_PORT: <number> toNumber(process.env.WEBSOCKET_PORT),
  WEBSOCKET_EXTERNAL_PORT: <number> toNumber(process.env.WEBSOCKET_EXTERNAL_PORT),
